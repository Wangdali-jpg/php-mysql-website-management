...
<tr> 
<td>级别ID：</td> 
<td><input type="varchar" id="level_id" name="level_id" required="required"></td> 
</tr> 
...
//用户名存在
$sql_search = "select * from level_info where level_id = '$level_id'"; 
...
<tr>
 <td>级别ID</td><td>级别名</td>
</tr>

<?php
if(!empty($level_id)){
    echo "<tr><td>$level_id</td><td>$name</td><tr>";
}
else{
