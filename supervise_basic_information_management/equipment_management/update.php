...
//建立连接
    ...
    //准备SQL语句,查询设备ID
    $sql_select1 = "SELECT * FROM equipment_info "; 
    //执行SQL语句
    ...
    //准备SQL语句,查询设备类别名
    $sql_select3 = "SELECT * FROM equipmentcategory_info "; 
    //执行SQL语句
...
<!--头部--> 
<div class="header"> <h1>更新设备名称页面</h1> </div> 
...
<td>设备类别名</td>
<td>
    <select name = 'subject3[]' required="required">
        <option>设备类别</option>
        <?php
