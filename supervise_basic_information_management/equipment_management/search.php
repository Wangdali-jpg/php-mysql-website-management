...
<!--头部--> 
<div class="header"> <h1>查询设备名称页面</h1> 
</div> 
...
<tr>
 <td>设备ID</td><td>设备名</td><td>设备类别ID</td><td>位置ID</td>
</tr>

<?php
if(!empty($equipment_id)){
    echo "<tr><td>$equipment_id</td><td>$name</td><td>$equipmentcategory_id</td><td>$location_id</td><tr>";
}
else{
...
<table style='text-align:left;border:solid' border="1">	
		<tr><td>设备ID</td><td>设备名</td><td>设备类别ID</td><td>位置ID</td></tr>
 <?php
     // $conn = mysqli_connect("localhost", "root", "pwd_1234567", "zhongshiyouvs"); 
     require_once('../../initial_interface/db_config.php');
    $conn = db_connect();
