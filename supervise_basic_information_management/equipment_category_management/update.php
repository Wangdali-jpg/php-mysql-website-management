...
//建立连接
    ...
    //准备SQL语句,查询用部门ID
    $sql_select1 = "SELECT equipmentcategory_id FROM equipmentcategory_info "; 
    //执行SQL语句
    ...
    while($row1 = $ret1->fetch_assoc()) {  
        $arr1[] = $row1['equipmentcategory_id'];
    }
    //数组重复数据去重
...
<!--头部--> 
<div class="header"> <h1>更新设备类别页面</h1> </div> 
