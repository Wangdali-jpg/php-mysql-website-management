...
<!--头部--> 
<div class="header"> <h1>查询监管状态页面</h1> 
</div> 
...
<tr> 
<td>状态ID：</td> 
<td><input type="varchar" id="status_id" name="status_id" required="required"></td> 
</tr> 
...
<tr>
 <td>监管状态ID</td><td>监管状态名</td>
</tr>

<?php
if(!empty($status_id)){
    echo "<tr><td>$status_id</td><td>$name</td><tr>";
}
else{
