...
<!--头部--> 
<div class="header"> <h1>新增监管分配页面</h1> </div> 
<!--中部--> 
<div class="middle"> 
...
<tr>
<td>
<img src="level.jpg"  alt="上海鲜花港 - 郁金香" />
<?php
echo '<img src="level.jpg" width="100" height="100">';
?>
</td>
</tr>
<tr> 
<td>父ID：</td> 
<td><input type="varchar" id="parent_id" name="parent_id" required="required"></td> 
</tr>
<tr>
<td>分配者</td>
<td>
...
<tr> 
<td>分配时间：</td> 
<td><input type="date" id="assign_time" name="assign_time" required="required"></td> 
</tr>
<tr> 
<td>开始时间：</td> 
