...
<tr> 
<td>部门ID：</td> 
<td><input type="varchar" id="department_id" name="department_id" required="required"></td> 
</tr> 
...
<tr>
 <td>部ID</td><td>部门名</td><td>公司ID</td>
</tr>

<?php
if(!empty($department_id)){
    echo "<tr><td>$department_id</td><td>$name</td><td>$company_id</td><tr>";
}
else{
...
<table style='text-align:left;border:solid' border="1">	
		<tr><td>部门ID</td><td>部门名</td><td>公司ID</td></tr>
 <?php
     // $conn = mysqli_connect("localhost", "root", "pwd_1234567", "zhongshiyouvs"); 
     require_once('../../initial_interface/db_config.php');
    $conn = db_connect();
